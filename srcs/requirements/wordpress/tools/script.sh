...
php wp-cli.phar core install --admin_user=seongjki --admin_password=4242 --admin_email=seongjki@gmail.com --url="http://127.0.0.1:10101" --title="seongjki's blog" --allow-root
